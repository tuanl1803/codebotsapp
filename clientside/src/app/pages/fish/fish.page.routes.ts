	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				canActivate: [
					RoleGuard,
					// % protected region % [Add any additional guards for Fish Wrapping Tile here] off begin
					// % protected region % [Add any additional guards for Fish Wrapping Tile here] end
				],
				data: {
					expectedRoles: [
						'FISHNATIC',
					...
					// % protected region % [Customise your data passed to data for Fish Wrapping Tile here] off begin
					// % protected region % [Customise your data passed to data for Fish Wrapping Tile here] end
				},
				// % protected region % [Add any additional route configuration for Fish Wrapping Tile here] off begin
				// % protected region % [Add any additional route configuration for Fish Wrapping Tile here] end
			},
		]
	}
