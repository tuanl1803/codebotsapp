...
export class FishnaticDataFactory extends UserDataFactory<FishnaticModel> {
	...
	create(): FishnaticModel {
		let newModel = new FishnaticModel();
	...
	createAll(size: number = 10): FishnaticModel[] {
		let newModels: FishnaticModel[] = [];
	...
	/**
	 * Given a blank model of type Fishnatic, populate the model with its properties.
