...
export class SpeciesDataFactory extends AbstractDataFactory<SpeciesModel> {
	...
	createAll(size: number = 10): SpeciesModel[] {
		let newModels: SpeciesModel[] = [];
	...
	/**
	 * Given a blank model of type Species, populate the model with its properties.
