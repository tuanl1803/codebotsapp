...
export class FishDataFactory extends AbstractDataFactory<FishModel> {
	...
	createAll(size: number = 10): FishModel[] {
		let newModels: FishModel[] = [];
	...
	/**
	 * Given a blank model of type Fish, populate the model with its properties.
