...
export class TankDataFactory extends AbstractDataFactory<TankModel> {
	...
	createAll(size: number = 10): TankModel[] {
		let newModels: TankModel[] = [];
	...
	/**
	 * Given a blank model of type Tank, populate the model with its properties.
