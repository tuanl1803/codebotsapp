...
export class AdminDataFactory extends UserDataFactory<AdminModel> {
	...
	createAll(size: number = 10): AdminModel[] {
		let newModels: AdminModel[] = [];
	...
	/**
	 * Given a blank model of type Admin, populate the model with its properties.
