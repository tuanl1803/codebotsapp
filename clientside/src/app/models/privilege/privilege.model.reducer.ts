	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.PrivilegeModelActionTypes.CREATE_PRIVILEGE_OK:
				const createdModel = (action as modelAction.CreatePrivilegeModelOK).stateConfig.targetModel;
			...
			case modelAction.PrivilegeModelActionTypes.CREATE_ALL_PRIVILEGE_OK:
				const createdModels = (action as modelAction.CreateAllPrivilegeModelOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.CreateAllPrivilegeModelOK).stateConfig.collectionId;
			...
			case modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE_OK:
				const deletedModelId = (action as modelAction.DeletePrivilegeModelOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.UpdatePrivilegeModelOK).stateConfig.collectionId;
			...
			case modelAction.PrivilegeModelActionTypes.DELETE_ALL_PRIVILEGE_OK:
				const deletedModelIds = (action as modelAction.DeletePrivilegeModelOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.UpdatePrivilegeModelOK).stateConfig.collectionId;
			...
			case modelAction.PrivilegeModelActionTypes.UPDATE_PRIVILEGE_OK:
				const updatedModel = (action as modelAction.UpdatePrivilegeModelOK).stateConfig.targetModel;
			...
			case modelAction.PrivilegeModelActionTypes.UPDATE_ALL_PRIVILEGE_OK:
				const updatedModels = (action as modelAction.UpdateAllPrivilegeModelOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.UpdateAllPrivilegeModelOK).stateConfig.collectionId;
			...
			case modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_OK:
				let fetchedModel = (action as modelAction.FetchPrivilegeModelOK).stateConfig.targetModel;
			...
			case modelAction.PrivilegeModelActionTypes.FETCH_ALL_PRIVILEGE_OK:
				const totalCountAfterFetchAll = (action as modelAction.FetchAllPrivilegeModelsOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.FetchAllPrivilegeModelsOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.FetchAllPrivilegeModelsOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.FetchAllPrivilegeModelsOK).stateConfig.queryParams;
			...
			case modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDIT_OK:
				const audits = (action as modelAction.FetchPrivilegeModelAuditOK).audits;
			...
			case modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.FetchPrivilegeModelAuditsByEntityIdOK).audits;
			...
			case modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.FetchPrivilegeModelsWithQueryOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.FetchPrivilegeModelsWithQueryOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.FetchPrivilegeModelsWithQueryOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.FetchPrivilegeModelsWithQueryOK).stateConfig.queryParams;
			...
			case modelAction.PrivilegeModelActionTypes.FETCH_LAST_PRIVILEGE_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.FetchLastPrivilegeModelsWithQueryOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.FetchLastPrivilegeModelsWithQueryOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.FetchLastPrivilegeModelsWithQueryOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.FetchLastPrivilegeModelsWithQueryOK).stateConfig.queryParams;
			...
			case modelAction.PrivilegeModelActionTypes.COUNT_PRIVILEGES_OK:
				const totalCountAfterCount = (action as modelAction.CountPrivilegeModelsOK).stateConfig.totalCount;
			...
			case modelAction.PrivilegeModelActionTypes.INITIALISE_PRIVILEGE_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.InitialisePrivilegeCollectionState).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.InitialisePrivilegeCollectionState).stateConfig.queryParams;
