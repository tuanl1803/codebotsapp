...
/**
 * FishCollectionState would store the state of a collection of Fish
 */
export interface FishCollectionState extends CollectionState {
 ...
 */
export interface FishModelAudit extends AbstractModelAudit<FishModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * FishModelState would store the state of the model
 */
export interface FishModelState {
	collectionState: {
		[key: string]: FishCollectionState;
	};
	data: {
		[id: string]: FishModel;
	};
	totalCount: number;
	audits: FishModelAudit[];
 ...
 */
export const initialFishCollectionState: FishCollectionState = {
...
/**
 * The initial state of FishModelState
 */
export const initialState: FishModelState = {
	collectionState: {
