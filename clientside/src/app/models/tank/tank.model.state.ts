...
/**
 * TankCollectionState would store the state of a collection of Tank
 */
export interface TankCollectionState extends CollectionState {
 ...
 */
export interface TankModelAudit extends AbstractModelAudit<TankModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TankModelState would store the state of the model
 */
export interface TankModelState {
	collectionState: {
		[key: string]: TankCollectionState;
	};
	data: {
		[id: string]: TankModel;
	};
	totalCount: number;
	audits: TankModelAudit[];
 ...
 */
export const initialTankCollectionState: TankCollectionState = {
...
/**
 * The initial state of TankModelState
 */
export const initialState: TankModelState = {
	collectionState: {
