...
/**
 * AdminCollectionState would store the state of a collection of Admin
 */
export interface AdminCollectionState extends CollectionState {
 ...
 */
export interface AdminModelAudit extends AbstractModelAudit<AdminModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * AdminModelState would store the state of the model
 */
export interface AdminModelState {
	collectionState: {
		[key: string]: AdminCollectionState;
	};
	data: {
		[id: string]: AdminModel;
	};
	totalCount: number;
	audits: AdminModelAudit[];
 ...
 */
export const initialAdminCollectionState: AdminCollectionState = {
...
/**
 * The initial state of AdminModelState
 */
export const initialState: AdminModelState = {
	collectionState: {
