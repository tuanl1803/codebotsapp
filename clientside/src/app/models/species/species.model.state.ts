...
/**
 * SpeciesCollectionState would store the state of a collection of Species
 */
export interface SpeciesCollectionState extends CollectionState {
 ...
 */
export interface SpeciesModelAudit extends AbstractModelAudit<SpeciesModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SpeciesModelState would store the state of the model
 */
export interface SpeciesModelState {
	collectionState: {
		[key: string]: SpeciesCollectionState;
	};
	data: {
		[id: string]: SpeciesModel;
	};
	totalCount: number;
	audits: SpeciesModelAudit[];
 ...
 */
export const initialSpeciesCollectionState: SpeciesCollectionState = {
...
/**
 * The initial state of SpeciesModelState
 */
export const initialState: SpeciesModelState = {
	collectionState: {
