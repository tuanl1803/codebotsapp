...
/**
 * Effect class used for side effects related to Species model.
 */
@Injectable()
export class SpeciesEffect {
	...
	constructor(
		...
		protected readonly service: SpeciesService,
	...
	countModels = this.action$.pipe(
		...
		ofType<modelAction.CountSpeciesModels>(modelAction.SpeciesModelActionTypes.COUNT_SPECIESS),
		...
		concatMap((action) => {
			...
			return this.service.count().pipe(
				...
				map(stateConfig => new modelAction.CountSpeciesModelsOK(
					{
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.CountSpeciesModelsFail(
							err
						)
					];
				}),
	...
	fetchedModel = this.action$.pipe(
		...
		ofType<modelAction.FetchSpeciesModel>(modelAction.SpeciesModelActionTypes.FETCH_SPECIES),
		...
		concatMap((action) => {
			...
			return this.service.get(modelId, queryParams).pipe(
				...
				map(stateConfig => new modelAction.FetchSpeciesModelOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.FetchSpeciesModelFail(
							modelId,
							err
						)
					];
	...
	fetchedModels = this.action$.pipe(
		...
		ofType<modelAction.FetchAllSpeciesModels>(modelAction.SpeciesModelActionTypes.FETCH_ALL_SPECIES),
		...
		concatMap((action) => {
			...
			return this.service.getAll().pipe(
				...
				map(stateConfig => new modelAction.FetchAllSpeciesModelsOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.FetchAllSpeciesModelsFail(
							err
						)
					];
				}),
	...
	fetchModelWithQuery = this.action$.pipe(
		...
		ofType<modelAction.FetchSpeciesModelsWithQuery>(modelAction.SpeciesModelActionTypes.FETCH_SPECIES_WITH_QUERY),
		...
		concatMap((action) => {
			...
			return this.service.getWithQuery(queryParams).pipe(
				...
				map(stateConfig => new modelAction.FetchSpeciesModelsWithQueryOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.FetchSpeciesModelsWithQueryFail(
							err
						)
					];
				}),
	...
	fetchLastModelWithQuery = this.action$.pipe(
		...
		ofType<modelAction.FetchLastSpeciesModelsWithQuery>(modelAction.SpeciesModelActionTypes.FETCH_LAST_SPECIES_WITH_QUERY),
		...
		concatMap((action) => {
			...
			return this.service.getLastWithQuery(queryParams).pipe(
				...
				map(stateConfig => new modelAction.FetchLastSpeciesModelsWithQueryOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.FetchLastSpeciesModelsWithQueryFail(
							err
						)
					];
				}),
	...
	createdModel = this.action$.pipe(
		...
		ofType<modelAction.CreateSpeciesModel>(modelAction.SpeciesModelActionTypes.CREATE_SPECIES),
		...
		concatMap((action) => {
			const modelToBeCreated = action.stateConfig.targetModel as SpeciesModel;
			const collectionId = action.stateConfig.collectionId;
			const queryParams = action.stateConfig.queryParams;
			...
			return this.service.create(modelToBeCreated, queryParams).pipe(
				...
				map(stateConfig => new modelAction.CreateSpeciesModelOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.CreateSpeciesModelFail(
							modelToBeCreated,
							err
						)
					];
	...
	createAllModels = this.action$.pipe(
		...
		ofType<modelAction.CreateAllSpeciesModel>(modelAction.SpeciesModelActionTypes.CREATE_ALL_SPECIES),

		// % protected region % [Add any additional operations before using the service for createdModel here] off begin
		// % protected region % [Add any additional operations before using the service for createdModel here] end

		concatMap((action) => {
			const modelsToCreate = action.stateConfig.targetModels as SpeciesModel[];
			const collectionId = action.stateConfig.collectionId;
			const queryParams = action.stateConfig.queryParams;
			...
			return this.service.createAll(modelsToCreate, queryParams).pipe(
				...
				map(stateConfig => new modelAction.CreateAllSpeciesModelOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.CreateAllSpeciesModelFail(
							modelsToCreate,
							err
						)
					];
	...
	updatedModel = this.action$.pipe(
		...
		ofType<modelAction.UpdateSpeciesModel>(modelAction.SpeciesModelActionTypes.UPDATE_SPECIES),
		...
		concatMap((action) => {
			...
			return this.service.update(new SpeciesModel({
				...modelToBeUpdated,
				...updates
			}), queryParams).pipe(
				...
				map(stateConfig => new modelAction.UpdateSpeciesModelOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.UpdateSpeciesModelFail(
							modelToBeUpdated,
							err
						)
					];
	...
	updateAllModels = this.action$.pipe(
		...
		ofType<modelAction.UpdateSpeciesModel>(modelAction.SpeciesModelActionTypes.UPDATE_ALL_SPECIES),
		...
		concatMap((action) => {
			...
			return this.service.updateAll(updatedModels, queryParams).pipe(
				...
				map(stateConfig => new modelAction.UpdateAllSpeciesModelOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.UpdateAllSpeciesModelFail(
							modelsToUpdate,
							err
						)
					];
	...
	deletedModel = this.action$.pipe(
		...
		ofType<modelAction.DeleteSpeciesModel>(modelAction.SpeciesModelActionTypes.DELETE_SPECIES),
		...
		concatMap((action) => {
			...
			return this.service.delete(modelIdToBeDeleted).pipe(
				...
				map(stateConfig => new modelAction.DeleteSpeciesModelOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.DeleteSpeciesModelFail(
							modelIdToBeDeleted,
							err
						)
					];
	...
	deletedModels = this.action$.pipe(
		...
		ofType<modelAction.DeleteSpeciesModels>(modelAction.SpeciesModelActionTypes.DELETE_ALL_SPECIES),
		...
		concatMap((action) => {
			...
			return this.service.deleteAll(modelIdsToBeDeleted).pipe(
				...
				map(stateConfig => new modelAction.DeleteSpeciesModelsOK(
					{
						...action.stateConfig,
						...stateConfig,
				...
				catchError((err) => {
					return [
						new modelAction.DeleteSpeciesModelsFail(
							modelIdsToBeDeleted,
							err
						)
					];
	...
	fetchedAudits = this.action$.pipe(
		...
		ofType<modelAction.FetchSpeciesModelAudit>(modelAction.SpeciesModelActionTypes.FETCH_SPECIES_AUDIT),
		...
		concatMap((action) => {
			...
			return this.service.getAudits().pipe(
				...
				map(audits => new modelAction.FetchSpeciesModelAuditOK(
					audits,
				...
				catchError((err) => {
					return [
						new modelAction.FetchSpeciesModelAuditFail(
							err
						)
					];
				}),
	...
	fetchedAuditsByEntityId = this.action$.pipe(
		...
		ofType<modelAction.FetchSpeciesModelAuditsByEntityId>(modelAction.SpeciesModelActionTypes.FETCH_SPECIES_AUDITS_BY_ENTITY_ID),
		...
		concatMap((action) => {
			...
			return this.service.getAuditsByEntityId(entityId).pipe(
				...
				map(audits => new modelAction.FetchSpeciesModelAuditsByEntityIdOK(
					audits,
				...
				catchError((err) => {
					return [
						new modelAction.FetchSpeciesModelAuditsByEntityIdFail(
							err
						)
					];
				}),
