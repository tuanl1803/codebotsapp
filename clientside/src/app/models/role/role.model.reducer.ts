	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.RoleModelActionTypes.CREATE_ROLE_OK:
				const createdModel = (action as modelAction.CreateRoleModelOK).stateConfig.targetModel;
			...
			case modelAction.RoleModelActionTypes.CREATE_ALL_ROLE_OK:
				const createdModels = (action as modelAction.CreateAllRoleModelOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.CreateAllRoleModelOK).stateConfig.collectionId;
			...
			case modelAction.RoleModelActionTypes.DELETE_ROLE_OK:
				const deletedModelId = (action as modelAction.DeleteRoleModelOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.UpdateRoleModelOK).stateConfig.collectionId;
			...
			case modelAction.RoleModelActionTypes.DELETE_ALL_ROLE_OK:
				const deletedModelIds = (action as modelAction.DeleteRoleModelOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.UpdateRoleModelOK).stateConfig.collectionId;
			...
			case modelAction.RoleModelActionTypes.UPDATE_ROLE_OK:
				const updatedModel = (action as modelAction.UpdateRoleModelOK).stateConfig.targetModel;
			...
			case modelAction.RoleModelActionTypes.UPDATE_ALL_ROLE_OK:
				const updatedModels = (action as modelAction.UpdateAllRoleModelOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.UpdateAllRoleModelOK).stateConfig.collectionId;
			...
			case modelAction.RoleModelActionTypes.FETCH_ROLE_OK:
				let fetchedModel = (action as modelAction.FetchRoleModelOK).stateConfig.targetModel;
			...
			case modelAction.RoleModelActionTypes.FETCH_ALL_ROLE_OK:
				const totalCountAfterFetchAll = (action as modelAction.FetchAllRoleModelsOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.FetchAllRoleModelsOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.FetchAllRoleModelsOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.FetchAllRoleModelsOK).stateConfig.queryParams;
			...
			case modelAction.RoleModelActionTypes.FETCH_ROLE_AUDIT_OK:
				const audits = (action as modelAction.FetchRoleModelAuditOK).audits;
			...
			case modelAction.RoleModelActionTypes.FETCH_ROLE_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.FetchRoleModelAuditsByEntityIdOK).audits;
			...
			case modelAction.RoleModelActionTypes.FETCH_ROLE_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.FetchRoleModelsWithQueryOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.FetchRoleModelsWithQueryOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.FetchRoleModelsWithQueryOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.FetchRoleModelsWithQueryOK).stateConfig.queryParams;
			...
			case modelAction.RoleModelActionTypes.FETCH_LAST_ROLE_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.FetchLastRoleModelsWithQueryOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.FetchLastRoleModelsWithQueryOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.FetchLastRoleModelsWithQueryOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.FetchLastRoleModelsWithQueryOK).stateConfig.queryParams;
			...
			case modelAction.RoleModelActionTypes.COUNT_ROLES_OK:
				const totalCountAfterCount = (action as modelAction.CountRoleModelsOK).stateConfig.totalCount;
			...
			case modelAction.RoleModelActionTypes.INITIALISE_ROLE_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.InitialiseRoleCollectionState).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.InitialiseRoleCollectionState).stateConfig.queryParams;
