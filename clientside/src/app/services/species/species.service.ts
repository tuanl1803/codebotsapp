...
import {SpeciesModelAudit} from '../../models/species/species.model.state';
...
/**
 * Species service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SpeciesService extends AbstractHttpService<SpeciesModel, SpeciesModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			fragment SpeciesProperties on Species {
				...SpeciesBaseProperties
				name
			}
			${super.fragments('Species').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SpeciesModel>> {
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SpeciesModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.query<any>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SpeciesById as SpeciesModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						speciess: speciess(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SpeciesProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSpeciess(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.speciess as SpeciesModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						speciess: lastSpeciess(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SpeciesProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SpeciesModel, queryParams?: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($species: SpeciesInput!) {
			...
			tap(() => this.toastrService.success('Created Species entity successfully')),
			map(result => {
				...
				return {
					targetModel: result.data.species as SpeciesModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SpeciesModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($speciess: [SpeciesInput!]!) {
						species: createAllSpecies(speciess: $speciess) {
							...SpeciesProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
				...
				`,
				variables: {
					speciess: entities.map(entity => entity.toJSON()),
			...
			tap(() => this.toastrService.success('Created Multiple Species entities successfully')),
			map(result => {
				...
				return {
					targetModels: result.data.species as SpeciesModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SpeciesModel, queryParams?: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($species: SpeciesInput!) {
			...
			tap(() => this.toastrService.success('Updated Species entity successfully')),
			map(result => {
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SpeciesModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($speciess: [SpeciesInput!]!) {
						species: updateAllSpecies(speciess: $speciess) {
							...SpeciesProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
			...
			tap(() => this.toastrService.success('Update Multiple Species entities successfully')),
			map(result => {
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($speciesId: ID!) {
						speciesId: deleteSpeciesById(speciesId: $speciesId)
			...
			tap(() => this.toastrService.success('Deleted Species entity successfully')),
			map(result => {
				...
				return {
					targetModelId: result.data.speciesId as string,
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SpeciesModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($speciesIds: [ID!]!) {
						speciesIds: deleteAllSpeciesByIds(speciesIds: $speciesIds)
			...
			tap(() => this.toastrService.success('Deleted all Species entities successfully')),
			map(result => {
				...
				return {
					targetModelIds: result.data.speciesIds as string[],
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SpeciesModelAudit[]> {
		...
		return this.apollo.query<any>(
			...
			map(result => {
				let audits: SpeciesModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SpeciesModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SpeciesModelAudit[]> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetAuditsByEntityId($speciesId: ID!) {
						audits: speciesAuditsByEntityId(speciesId: $speciesId) {
							entity {
								...SpeciesProperties
							}
							timestamp
