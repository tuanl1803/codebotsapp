...
import {AdminModelAudit} from '../../models/admin/admin.model.state';
...
/**
 * Admin service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class AdminService extends UserService<AdminModel, AdminModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			fragment AdminProperties on Admin {
				...AdminUserProperties
			}
			${super.fragments('Admin').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<AdminModel>> {
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<AdminModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.query<any>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.AdminById as AdminModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						admins: admins(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...AdminProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countAdmins(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.admins as AdminModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						admins: lastAdmins(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...AdminProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: AdminModel, queryParams?: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($admin: AdminInput!) {
			...
			tap(() => this.toastrService.success('Created Admin entity successfully')),
			map(result => {
				...
				return {
					targetModel: result.data.admin as AdminModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: AdminModel[], queryParams?: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($admins: [AdminInput!]!) {
						admin: createAllAdmin(admins: $admins) {
							...AdminProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
				...
				`,
				variables: {
					admins: entities.map(entity => entity.toJSON()),
			...
			tap(() => this.toastrService.success('Created Multiple Admin entities successfully')),
			map(result => {
				...
				return {
					targetModels: result.data.admin as AdminModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: AdminModel, queryParams?: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($admin: AdminInput!) {
			...
			tap(() => this.toastrService.success('Updated Admin entity successfully')),
			map(result => {
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: AdminModel[], queryParams?: QueryParams): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($admins: [AdminInput!]!) {
						admin: updateAllAdmin(admins: $admins) {
							...AdminProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
			...
			tap(() => this.toastrService.success('Update Multiple Admin entities successfully')),
			map(result => {
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($adminId: ID!) {
						adminId: deleteAdminById(adminId: $adminId)
			...
			tap(() => this.toastrService.success('Deleted Admin entity successfully')),
			map(result => {
				...
				return {
					targetModelId: result.data.adminId as string,
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<AdminModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($adminIds: [ID!]!) {
						adminIds: deleteAllAdminByIds(adminIds: $adminIds)
			...
			tap(() => this.toastrService.success('Deleted all Admin entities successfully')),
			map(result => {
				...
				return {
					targetModelIds: result.data.adminIds as string[],
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<AdminModelAudit[]> {
		...
		return this.apollo.query<any>(
			...
			map(result => {
				let audits: AdminModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new AdminModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<AdminModelAudit[]> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetAuditsByEntityId($adminId: ID!) {
						audits: adminAuditsByEntityId(adminId: $adminId) {
							entity {
								...AdminProperties
							}
							timestamp
