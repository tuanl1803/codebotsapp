...
import {FishnaticModelAudit} from '../../models/fishnatic/fishnatic.model.state';
...
/**
 * Fishnatic service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class FishnaticService extends UserService<FishnaticModel, FishnaticModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			fragment FishnaticProperties on Fishnatic {
				...FishnaticUserProperties
			}
			${super.fragments('Fishnatic').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<FishnaticModel>> {
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<FishnaticModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query Get($id: ID!) {
						FishnaticById: fishnaticById(id: $id) {
							...FishnaticProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.FishnaticById as FishnaticModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						fishnatics: fishnatics(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...FishnaticProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countFishnatics(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.fishnatics as FishnaticModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						fishnatics: lastFishnatics(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...FishnaticProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: FishnaticModel, queryParams?: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($fishnatic: FishnaticInput!) {
						fishnatic: createFishnatic(fishnatic: $fishnatic) {
							...FishnaticProperties,
			...
			tap(() => this.toastrService.success('Created Fishnatic entity successfully')),
			map(result => {
				...
				return {
					targetModel: result.data.fishnatic as FishnaticModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: FishnaticModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($fishnatics: [FishnaticInput!]!) {
						fishnatic: createAllFishnatic(fishnatics: $fishnatics) {
							...FishnaticProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
				...
				`,
				variables: {
					fishnatics: entities.map(entity => entity.toJSON()),
			...
			tap(() => this.toastrService.success('Created Multiple Fishnatic entities successfully')),
			map(result => {
				...
				return {
					targetModels: result.data.fishnatic as FishnaticModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: FishnaticModel, queryParams?: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($fishnatic: FishnaticInput!) {
						fishnatic: updateFishnatic(fishnatic: $fishnatic) {
							...FishnaticProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
			...
			tap(() => this.toastrService.success('Updated Fishnatic entity successfully')),
			map(result => {
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: FishnaticModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($fishnatics: [FishnaticInput!]!) {
						fishnatic: updateAllFishnatic(fishnatics: $fishnatics) {
							...FishnaticProperties,
							${this.getExpands(queryParams ? queryParams.expands: [])}
						}
			...
			tap(() => this.toastrService.success('Update Multiple Fishnatic entities successfully')),
			map(result => {
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($fishnaticId: ID!) {
						fishnaticId: deleteFishnaticById(fishnaticId: $fishnaticId)
			...
			tap(() => this.toastrService.success('Deleted Fishnatic entity successfully')),
			map(result => {
				...
				return {
					targetModelId: result.data.fishnaticId as string,
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<FishnaticModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($fishnaticIds: [ID!]!) {
						fishnaticIds: deleteAllFishnaticByIds(fishnaticIds: $fishnaticIds)
			...
			tap(() => this.toastrService.success('Deleted all Fishnatic entities successfully')),
			map(result => {
				...
				return {
					targetModelIds: result.data.fishnaticIds as string[],
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<FishnaticModelAudit[]> {
		...
		return this.apollo.query<any>(
			...
			map(result => {
				let audits: FishnaticModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new FishnaticModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<FishnaticModelAudit[]> {
		...
		return this.apollo.query<any>(
			{
				query: gql`
					query GetAuditsByEntityId($fishnaticId: ID!) {
						audits: fishnaticAuditsByEntityId(fishnaticId: $fishnaticId) {
							entity {
								...FishnaticProperties
							}
							timestamp
