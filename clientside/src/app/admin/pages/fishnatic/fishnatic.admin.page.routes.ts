...
import {AdminFishnaticTileCrudComponent} from '../../tiles/crud/fishnatic/fishnatic.admin.tile.crud.component';
...
export const appRoutes: Routes = [
	{
		...
		canActivate: [
			AuthenticationGuard,
			RoleGuard
			// % protected region % [Add any additional guards for AdminFishnaticTile here] off begin
			// % protected region % [Add any additional guards for AdminFishnaticTile here] end
		],
		data: {
			/*
			 * Required
		...
		// % protected region % [Add any additional route configuration for crud AdminFishnaticTile here] off begin
		// % protected region % [Add any additional route configuration for crud AdminFishnaticTile here] end
	},
