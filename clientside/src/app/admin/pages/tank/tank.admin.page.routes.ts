...
import {AdminTankTileCrudComponent} from '../../tiles/crud/tank/tank.admin.tile.crud.component';
...
export const appRoutes: Routes = [
	{
		...
		canActivate: [
			AuthenticationGuard,
			RoleGuard
			// % protected region % [Add any additional guards for AdminTankTile here] off begin
			// % protected region % [Add any additional guards for AdminTankTile here] end
		],
		data: {
			/*
			 * Required
		...
		// % protected region % [Add any additional route configuration for crud AdminTankTile here] off begin
		// % protected region % [Add any additional route configuration for crud AdminTankTile here] end
	},
