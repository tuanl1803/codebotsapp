...
import {AdminAdminTileCrudComponent} from '../../tiles/crud/admin/admin.admin.tile.crud.component';
...
export const appRoutes: Routes = [
	{
		...
		canActivate: [
			AuthenticationGuard,
			RoleGuard
			// % protected region % [Add any additional guards for AdminAdminTile here] off begin
			// % protected region % [Add any additional guards for AdminAdminTile here] end
		],
		data: {
			/*
			 * Required
		...
		// % protected region % [Add any additional route configuration for crud AdminAdminTile here] off begin
		// % protected region % [Add any additional route configuration for crud AdminAdminTile here] end
	},
