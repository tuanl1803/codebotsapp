...
import {AdminFishnaticTileCrudComponent} from './fishnatic.admin.tile.crud.component';
...
@NgModule({
	declarations: [
		AdminFishnaticTileCrudComponent,
...
export class AdminFishnaticTileCrudModule {
}
