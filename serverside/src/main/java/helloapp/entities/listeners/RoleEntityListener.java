...
import helloapp.configs.security.auditing.services.RoleEntityReadAuditService;
...
public class RoleEntityListener {
	...
	@Autowired
	public void init(PermissionEvaluator permissionEvaluator, RoleEntityReadAuditService auditService) {
