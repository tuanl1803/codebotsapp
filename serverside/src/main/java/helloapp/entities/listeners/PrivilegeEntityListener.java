...
import helloapp.configs.security.auditing.services.PrivilegeEntityReadAuditService;
...
public class PrivilegeEntityListener {
	...
	@Autowired
	public void init(PermissionEvaluator permissionEvaluator, PrivilegeEntityReadAuditService auditService) {
