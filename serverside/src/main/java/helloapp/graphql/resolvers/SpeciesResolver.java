...
package helloapp.graphql.resolvers;
...
@Component
public class SpeciesResolver implements GraphQLResolver<SpeciesEntity> {
	...
	public Set<FishEntity> fishSpecies(SpeciesEntity species) {
		return species.getFishSpecies();
	}
