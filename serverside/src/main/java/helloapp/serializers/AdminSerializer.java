 ...
 */
public class AdminSerializer extends UserSerializer<AdminEntity> {
	...
	@Override
	public void serialize(AdminEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
