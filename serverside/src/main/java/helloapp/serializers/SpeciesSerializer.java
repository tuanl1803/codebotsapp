 ...
 */
public class SpeciesSerializer extends AbstractSerializer<SpeciesEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public SpeciesSerializer() {
		super(SpeciesEntity.class);
	...
	@Override
	public void serialize(SpeciesEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
