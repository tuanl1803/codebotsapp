 ...
 */
public class FishnaticSerializer extends UserSerializer<FishnaticEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public FishnaticSerializer() {
		super(FishnaticEntity.class);
	...
	@Override
	public void serialize(FishnaticEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
