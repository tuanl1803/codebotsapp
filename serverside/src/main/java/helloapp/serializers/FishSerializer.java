 ...
 */
public class FishSerializer extends AbstractSerializer<FishEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public FishSerializer() {
		super(FishEntity.class);
	...
	@Override
	public void serialize(FishEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		if (value.getBorn() != null) {
			writeStringField(gen, "born", value.getBorn().toString());
		}
